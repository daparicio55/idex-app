...
@section('content_header')
    <h1>Registrar cantidad de Vacantes</h1>
@stop

@section('content')
{!! Form::open(['id'=>'frm_datos','name'=>'frm_datos','route'=>'admisiones.vacantes.store','method'=>'POST','autocomplete'=>'off']) !!}
{!! Form::hidden('admisione_id', $admisione->id, [null]) !!}
<div class="row">
...
{!! Form::close() !!}            
            <a class="btn btn-danger btn-lg" href="{{url(asset('admisiones/vacantes/?id='.$admisione->id))}}">
