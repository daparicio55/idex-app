...
@section('title', 'Sumativo Editar')
@section('content_header')
    <h1>Editar Nuevo Sumativo Cepre</h1>
@stop

@section('content')
{!! Form::model($sumativo, ['route'=>['cepres.sumativos.configuraciones.update',$sumativo->id],'method'=>'put','autocomplete'=>'off','id'=>'frm_datos','name'=>'frm_datos']) !!}
<div class="row">
