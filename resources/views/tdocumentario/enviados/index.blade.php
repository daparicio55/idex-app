...
@section('content_header')
    ...
    <span class="text-success font-italic">bandeja de salida</span>
@stop
@section('content')
@if (session('info'))
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2"><b>Enviado para:</b></td>
                        <td colspan="3">
                            {{ $recibido->receptor->name }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="text-align: right"> fecha: {{ date('d-m-Y',strtotime($recibido->fecha)) }} hora: {{ $recibido->hora }}</td>
                    </tr>
                    <tr>
