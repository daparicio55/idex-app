...
@section('title', 'Registro de Reingreso')

@section('content_header')
    <h1>Registro de reingreso</h1>
    <a class="btn btn-danger mt-1" href="{{ route('sacademica.reingresos.index') }}">
        <i class="fas fa-backward"></i> Regresar
    </a>
@stop

@section('content')
@include('sacademica.reingresos.mestudiante')
...
<div class="card">
    ...
    <div class="card-footer">
        <h5 class="h5"><i class="fas fa-list"></i> Licencias sin registro de REINGRESO</h5>
    </div>
    <div class="card-body">
        ...
        function selectestudiante(id){
            ...
            fetch(ruta).then(function(response){
                ...
                data.matriculas.forEach(matricula => {
                    if(matricula.licencia.id !== null && matricula.licencia.id !== undefined){
                        if(matricula.licencia.reingreso.id == null && matricula.licencia.reingreso.id == undefined){
                            ...
                            frm.method = "POST";
                            frm.action = "{{ asset('') }}"+"sacademica/reingresos/"+matricula.licencia.id;
                            let _token = '@csrf';
