...
@section('title', 'Registro de Capacidad')
@section('content_header')
    <h1><i class="fas fa-business-time"></i> Nueva Capacidad</h1>
    <h5 class="mt-2">{{ $modulo->nombre }} - {{ $modulo->carrera->nombreCarrera }}</h5>
@stop
@section('content')
{!! Form::open(['route'=>'sacademica.ability.store','method'=>'post','id'=>'formulario']) !!}
<div class="row">
    <div class="col-sm-12">
