...
{!! Form::model($unidad, ['id'=>'frm','method'=>'put','autocomplete'=>'off','route'=>['sacademica.udidacticas.update',$unidad->id]]) !!}
<div class="row">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                    ...
                    {!! Form::number('orden', null, ['class'=>'form-control','step'=>1,'required']) !!}
                </div>
            </div>
        </div>
    </div>
...
{!! Form::close() !!}
        <a class="btn btn-danger" href="{{ url('sacademica/mformativos/'.$unidad->mformativo_id) }}">
