...
@section('content_header')
    <h1><i class="far fa-address-book text-success"></i> Nuevo Itineario Formativo</h1>
@stop
@section('content')

{!! Form::open(['id'=>'frm','method'=>'post','route'=>'sacademica.iformativos.store','autocomplete'=>'off']) !!}
<div class="row">
